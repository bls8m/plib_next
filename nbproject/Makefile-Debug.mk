...
${OBJECTDIR}/backend/atmel_avr/lib_atmegaxxx.o: backend/atmel_avr/lib_atmegaxxx.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/backend/atmel_avr/lib_atmegaxxx.o backend/atmel_avr/lib_atmegaxxx.c

${OBJECTDIR}/backend/pc_fake/lib_pc.o: backend/pc_fake/lib_pc.c
	${MKDIR} -p ${OBJECTDIR}/backend/pc_fake
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/backend/pc_fake/lib_pc.o backend/pc_fake/lib_pc.c
...
${OBJECTDIR}/plib_next.o: plib_next.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/plib_next.o plib_next.c
